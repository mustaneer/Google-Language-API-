		...
		<div class="span8 offset2 contentBox">
			<div id="search_bar">
				...
				<div class="input-append" id="search_container">   
					<input class="span10" id="wordinput_manual" name="word_name" placeholder="Search  -  Dictionary"  maxlength="50"  style="height:25px;" autofocus="autofocus" type="text"/>
					<button title="search" class="btn btn-primary " id="submit">&nbsp;<i class="icon-search icon-white"></i></button>
				</div>   
