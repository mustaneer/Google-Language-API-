...
?>
		...
		<div class="span8 offset2 contentBox">
			<div id="search_bar">
				<div class="input-append" id="search_container">
					<textarea rows="10" class="span6" id="wordinput" name="word_name" placeholder="Search  -  Dictionary" ><?php echo $contents; ?></textarea>
					<button title="search" class="btn btn-primary " id="submit-read" style="margin: 100px 0 0 10px;">Translate</button>
				</div>  
				...
				<div>
					<form action="" method="post" enctype="multipart/form-data">
					   <label for="file">Filename:</label> <input type="file" name="file" id="file" required />
	...
	<div class="row span12 meanings">
		<div class=" span8 offset2 contentBox" style="position:relative;">
			...
			<div id="speak" style="display:none;" ><img src="resources/img/speaker-icon.jpg" /></div>
		</div>
	</div>      
